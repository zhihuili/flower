 ...
 */
package com.ly.train.flower.sample.web.async;
...
public class AsyncServlet extends FlowerHttpServlet {
  ...
  private void buildServiceEnv() {
    serviceFactory.registerService("serviceA", "com.ly.train.flower.sample.web.async.ServiceA");
    serviceFactory.registerService("serviceB", "com.ly.train.flower.sample.web.async.ServiceB");
