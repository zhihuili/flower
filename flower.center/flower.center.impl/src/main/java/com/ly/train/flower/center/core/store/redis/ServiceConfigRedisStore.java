 ...
 */
package com.ly.train.flower.center.core.store.redis;
 ...
 * @author leeyazhou
 */
public class ServiceConfigRedisStore implements ServiceConfigStore {


  static final Logger logger = LoggerFactory.getLogger(ServiceConfigRedisStore.class);

  private CacheManager cacheManager = CacheManager.get("flower_center_service_config");
